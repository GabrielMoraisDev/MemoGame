...
export default function Easy() {
  ...
  const [matchedCards, setMatchedCards] = useState<boolean[]>(Array(10).fill(false));
  ...
  return (
    ...
    {sucess === false ?<HomeBtn color='easy'/> : ''}
      <div className="inline w-full absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        ...
        <div className='grid grid-rows-5 grid-cols-2 w-[55%] md:w-[20%] lg:w-[30%] xl:w-[13%] 2xl:w-[13%] gap-0 m-auto flex place-items-center h-[68vh]'>
          {cards}
        </div>
      </div>
    </div>
